...
var PassMedia = /** @class */ (function () {
    ...
    PassMedia.prototype.requestAutologin = function (result) {
        return new Promise(function (resolve) {
            ...
            http.post(passmedia_env_1.API.AUTOLOGIN)
                ...
                resolve(__assign(__assign({}, res), params));
            });
        });
    };
    ...
    PassMedia.prototype.rejectAutologin = function () {
        cookies.set(passmedia_env_1.COOKIE.NAME, this.capping.getJSON(), __assign(__assign({}, passmedia_env_1.COOKIE.DURATION), passmedia_env_1.COOKIE.PATH_AND_DOMAIN));
    };
